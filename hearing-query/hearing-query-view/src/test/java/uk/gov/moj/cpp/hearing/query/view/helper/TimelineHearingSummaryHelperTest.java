...
public class TimelineHearingSummaryHelperTest {
    ...
    public void setup() throws IOException {
        ...
        crackedIneffectiveTrial = CrackedIneffectiveTrial.crackedIneffectiveTrial()
    ...
    public void shouldHandleEmptyFields() {
        final TimelineHearingSummary timeLineHearingSummary = timelineHearingSummaryHelper.createTimeLineHearingSummary(new HearingDay(), new Hearing(), CrackedIneffectiveTrial.crackedIneffectiveTrial().build(),createObjectBuilder().build(), hearingYouthCourtDefendantList, caseId);
