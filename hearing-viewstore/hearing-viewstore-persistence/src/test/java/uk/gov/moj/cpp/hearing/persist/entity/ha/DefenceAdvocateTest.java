...
public class DefenceAdvocateTest {
    ...
    public void shouldHaveABuilderInnerClass() {
        assertTrue(hasInnerStaticClass(DefenceAdvocate.class, "DefenceAdvocateAdvocateBuilder"));
    }
    
    @Test
    public void shouldHaveAParameterizedConstructor() {
        assertTrue(hasParameterizedConstructor(DefenceAdvocate.class, DefenceAdvocate.DefenceAdvocateAdvocateBuilder.class));
    }
