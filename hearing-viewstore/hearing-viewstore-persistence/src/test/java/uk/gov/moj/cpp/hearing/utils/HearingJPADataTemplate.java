...
public final class HearingJPADataTemplate {
    ...
    private HearingJPADataTemplate(final boolean sysoutPrint) {
        ...
        randomStreamOf(1, uk.gov.moj.cpp.hearing.persist.entity.ha.DefenceCounsel.class)
                .forEach(defenceCounsel -> {
                    hearingEntity.getDefenceCounsels().add(defenceCounsel);
                });
