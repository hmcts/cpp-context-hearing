...
public interface HearingEventDefinitionRepository extends EntityRepository<HearingEventDefinition, UUID> {
    ...
    String FIND_ALL_ORDER_BY_SEQUENCE_TYPE_SEQUENCE_NUMBER_AND_ACTION_LABEL =
    ...
    @Modifying
    @Query("delete HearingEventDefinition")
    void deleteAll();

    @Query(value = FIND_ALL_ORDER_BY_SEQUENCE_TYPE_SEQUENCE_NUMBER_AND_ACTION_LABEL)
    List<HearingEventDefinition> findAllOrderBySequenceTypeSequenceNumberAndActionLabel();
}