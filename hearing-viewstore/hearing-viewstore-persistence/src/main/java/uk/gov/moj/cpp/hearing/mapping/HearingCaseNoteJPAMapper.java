...
public class HearingCaseNoteJPAMapper {
    ...
    public HearingCaseNote toJPA(final Hearing hearing, final uk.gov.justice.json.schemas.core.HearingCaseNote pojo) {
        if (null == pojo) {
            return null;
        }
        final HearingCaseNote hearingCaseNote = new HearingCaseNote();
        hearingCaseNote.setId(new HearingSnapshotKey(pojo.getId(), hearing.getId()));
    ...
    public uk.gov.justice.json.schemas.core.HearingCaseNote fromJPA(final HearingCaseNote entity) {
        if (null == entity) {
            return null;
        }
    ...
    public Set<HearingCaseNote> toJPA(Hearing hearing, List<uk.gov.justice.json.schemas.core.HearingCaseNote> pojos) {
        if (null == pojos) {
            return new HashSet<>();
        }
