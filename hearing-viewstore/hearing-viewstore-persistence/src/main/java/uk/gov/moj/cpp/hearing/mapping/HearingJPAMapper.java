...
public class HearingJPAMapper {
    ...
    public HearingJPAMapper(final CourtCentreJPAMapper courtCentreJPAMapper,
            final DefenceCounselJPAMapper defenceCounselJPAMapper,
            ...
            final ProsecutionCounselJPAMapper prosecutionCounselJPAMapper,
        ...
        this.defenceCounselJPAMapper = defenceCounselJPAMapper;
        ...
        this.prosecutionCounselJPAMapper = prosecutionCounselJPAMapper;
    ...
    public Hearing toJPA(final uk.gov.justice.json.schemas.core.Hearing pojo) {
        if (null == pojo) {
            return null;
        }
        ...
        hearing.setProsecutionCounsels(prosecutionCounselJPAMapper.toJPA(hearing, pojo.getProsecutionCounsels()));
    ...
    public uk.gov.justice.json.schemas.core.Hearing fromJPA(final Hearing entity) {
        if (null == entity) {
            return null;
        }
        return uk.gov.justice.json.schemas.core.Hearing.hearing()
                .withId(entity.getId())
                .withCourtCentre(courtCentreJPAMapper.fromJPA(entity.getCourtCentre()))
                .withDefenceCounsels(defenceCounselJPAMapper.fromJPA(entity.getDefenceCounsels()))
                ...
                .withProsecutionCounsels(prosecutionCounselJPAMapper.fromJPA(entity.getProsecutionCounsels()))
