...
public class AssociatedPersonJPAMapper {
    ...
    AssociatedPerson toJPA(final Hearing hearing, final Defendant defendant, final uk.gov.justice.core.courts.AssociatedPerson pojo) {
    ...
    public Set<AssociatedPerson> toJPA(final Hearing hearing, final Defendant defendant, final List<uk.gov.justice.core.courts.AssociatedPerson> pojos) {
        if (null == pojos) {
            return new HashSet<>();
        }
    ...
    uk.gov.justice.core.courts.AssociatedPerson fromJPA(final AssociatedPerson entity) {
        if (null == entity) {
            return null;
        }
        return uk.gov.justice.core.courts.AssociatedPerson.associatedPerson()
                .withPerson(personJPAMapper.fromJPA(entity.getPerson()))
                .withRole(entity.getRole())
                .build();
    }

    public List<uk.gov.justice.core.courts.AssociatedPerson> fromJPA(Set<AssociatedPerson> entities) {
        if (null == entities) {
