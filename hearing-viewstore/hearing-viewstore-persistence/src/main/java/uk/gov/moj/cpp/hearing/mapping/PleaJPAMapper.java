...
public class PleaJPAMapper {
    ...
    public Plea toJPA(final uk.gov.justice.json.schemas.core.Plea pojo) {
        if (null == pojo) {
            return null;
        }
    ...
    public uk.gov.justice.json.schemas.core.Plea fromJPA(final UUID offenceId, final Plea entity) {
        if (null == entity) {
            return null;
        }
        return uk.gov.justice.json.schemas.core.Plea.plea()
