...
public class InitiateHearingEventListenerTest {
    ...
    public void shouldInsertHearingWhenInitiated() {
        ...
        final uk.gov.justice.json.schemas.core.Hearing hearing = command.getHearing();
    ...
    private JsonEnvelope getInitiateHearingJsonEnvelope(final uk.gov.justice.json.schemas.core.Hearing hearing) {
