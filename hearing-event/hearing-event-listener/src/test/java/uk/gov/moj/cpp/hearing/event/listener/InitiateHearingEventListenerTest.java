...
public class InitiateHearingEventListenerTest {
    ...
    public void shouldInsertAhearingWhenInitiated() {
        ...
        assertThat(actualHearing.getHearingDays().get(0).getDateTime().toLocalDateTime(), is(hearing.getHearingDays().get(0).toLocalDateTime()));
        assertThat(actualHearing.getHearingDays().get(0).getDate(), is(hearing.getHearingDays().get(0).toLocalDate()));
