...
public class CaseDefendantDetailsUpdatedEventListener {
            ...
            with(defendant.getPersonDefendant(), defendantIn.getPersonDefendant(),
                    (personDefendantJpa, personDefendantPojo) -> {
                        if (nonNull(personDefendantJpa)) {
                            ...
                            personDefendantJpa.setBailStatus(personDefendantPojo.getBailStatus());
    ...
    private uk.gov.justice.json.schemas.core.Organisation getLegalEntityDefendantOrganisation(LegalEntityDefendant legalEntityDefendant) {
    ...
    private void setPerson(final Person personDetailsJpa, final uk.gov.justice.json.schemas.core.Person personDetailsPojo) {
        ...
        personDetailsJpa.setEthnicity(personDetailsPojo.getEthnicity());
    ...
    private void setOrganisation(final Organisation organisationJpa, uk.gov.justice.json.schemas.core.Organisation organisationPojo) {
        if (nonNull(organisationJpa) && nonNull(organisationPojo)) {
            organisationJpa.setId(organisationPojo.getId());
    ...
    private void setAddress(final Address addressJpa, final uk.gov.justice.json.schemas.core.Address addressPojo) {
