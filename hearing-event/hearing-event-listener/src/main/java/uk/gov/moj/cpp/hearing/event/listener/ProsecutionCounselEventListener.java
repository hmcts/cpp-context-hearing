...
public class ProsecutionCounselEventListener {
    ...
    public void prosecutionCounselAdded(final JsonEnvelope envelope) {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("hearing.prosecution-counsel-added for hearingId {} ", prosecutionCounselAdded.getHearingId());
        }
        if (hearing == null) {
    ...
    public void prosecutionCounselRemoved(final JsonEnvelope event) {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("hearing.prosecution-counsel-removed for hearingId {} ", prosecutionCounselRemoved.getHearingId());
        }
        if (hearing == null) {
            LOGGER.error("Hearing not found");
        } else {
