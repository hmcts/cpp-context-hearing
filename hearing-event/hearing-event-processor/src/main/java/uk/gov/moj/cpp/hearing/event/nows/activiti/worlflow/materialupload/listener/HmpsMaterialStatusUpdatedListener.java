...
public class HmpsMaterialStatusUpdatedListener {
    ...
    public static final String PUBLIC_RESULTINGHMPS_EVENT_NOWS_MATERIAL_STATUS_UPDATED = "public.resultinghmps.event.nows-material-status-updated";
    public static final String RECEIVE_STATUS_UPDATE_CONFIRMATION_HMPS = "receiveStatusUpdateConfirmationHmps";

    private static final Logger LOGGER = LoggerFactory.getLogger(HmpsMaterialStatusUpdatedListener.class.getName());
