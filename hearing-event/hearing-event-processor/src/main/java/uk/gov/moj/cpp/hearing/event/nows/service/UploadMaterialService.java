...
public class UploadMaterialService {
    ...
    public void uploadFile(final UUID userId, final UUID hearingId, final UUID materialId, final UUID fileId, final NowsNotificationDocumentState nowsNotificationDocumentState) {
        ...
        processMap.put(ProcessMapConstant.NOWS_NOTIFICATION_DOCUMENT_STATE, nowsNotificationDocumentState);
