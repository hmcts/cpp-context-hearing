...
public class HearingMaterialStatusUpdatedListenerTest {
    ...
    public void shouldNotSignalProcessWithActivitiIdIfCaseIdNotPresent() {
        ...
        when(event.metadata()).thenReturn(getMetedata());
        final JsonEnvelope jsonEnvelope = assembleEnvelopeWithPayloadAndMetaDetails(payload, PUBLIC_HEARING_EVENTS_NOWS_MATERIAL_STATUS_UPDATED, fakeId.toString(), USER_ID.toString());
