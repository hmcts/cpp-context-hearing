...
public class VariantSubscriptionProcessorTest {
    ...
    @Captor
    private ArgumentCaptor<NowsNotificationDocumentState> notifyNowsNotificationDocumentStateCaptor;
    ...
    @Before
    public void before() {
        this.nowsNotificationDocumentState = new NowsNotificationDocumentState();
        this.nowsNotificationDocumentState
                .setNowsTypeId(randomUUID())
                .setOriginatingCourtCentreId(randomUUID())
                .setUsergroups(asList("courtAdmin", "defenceCounsel"));
    }
