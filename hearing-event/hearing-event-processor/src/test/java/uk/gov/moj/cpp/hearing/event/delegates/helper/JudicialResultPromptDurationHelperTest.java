...
public class JudicialResultPromptDurationHelperTest {
    ...
    final Hearing hearing = new Hearing.Builder()
    ...
    @Test
    public void test() {
        final Optional<JudicialResultPromptDurationElement> resultPromptDurationElement = new JudicialResultPromptDurationHelper().populate(judicialResultPromptList, hearing, resultDefinition);
