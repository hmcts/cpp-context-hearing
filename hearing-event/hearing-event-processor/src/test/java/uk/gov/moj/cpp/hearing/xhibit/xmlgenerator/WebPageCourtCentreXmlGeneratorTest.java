...
public class WebPageCourtCentreXmlGeneratorTest {
    ...
    private static final String PUBLIC_DISPLAY_FILE_PATH = "xhibit/expectedWebPage.xml";
    ...
    public void shouldCreatePublicDisplayCourtCentreXml() throws IOException {
        ...
        final String generatedPublicDisplayXml = webPageCourtCentreXmlGenerator.generateXml(courtCentreGeneratorParameters);
