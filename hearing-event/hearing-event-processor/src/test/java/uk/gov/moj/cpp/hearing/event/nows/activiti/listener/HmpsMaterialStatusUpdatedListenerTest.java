...
public class HmpsMaterialStatusUpdatedListenerTest {
    ...
    public void shouldNotSignalProcessWithActivitiIdIfCaseIdNotPresent() {
        ...
        JsonEnvelope jsonEnvelope = assembleEnvelopeWithPayloadAndMetaDetails(payload, PUBLIC_RESULTINGHMPS_EVENT_NOWS_MATERIAL_STATUS_UPDATED, fakeId.toString(), USER_ID.toString());
