...
public class CreateSampleDraftResultSharedJson {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final List<String> destinations = Arrays.asList(
                ...
                HEARING_COMMAND_HEARING_COMMAND_HANDLER_SRC_RAML_JSON + "/hearing.draft-result-saved.json",
                HEARING_EVENT_HEARING_EVENT_LISTENER_SRC_RAML_JSON + "/hearing.draft-result-saved.json",
                HEARING_EVENT_HEARING_EVENT_PROCESSOR_SRC_RAML_JSON + "/hearing.draft-result-saved.json"
        );
