...
public class PublishLatestCourtCentreHearingEventsIT extends AbstractPublishLatestCourtCentreHearingIT {
    ...
    public void shouldRequestToPublishCourtListDefenceCouncilOpensCase() throws NoSuchAlgorithmException {
        ...
        createHearingEvent(hearingEventId, courtRoom3Id, randomUUID().toString(), DEFENCE_COUNCIL_NAME_OPENS_EVENT_DEFINITION_ID, eventTime, of(hearingTypeId), courtCentreId_1);
    ...
    public void shouldRequestToPublishCourtList() throws NoSuchAlgorithmException {
        ...
        createHearingEvent(randomUUID(), courtRoom1Id, randomUUID().toString(), START_HEARING_EVENT_DEFINITION_ID, eventTime, of(hearingTypeId), courtCentreId_2);
    ...
    public void shouldRequestToPublishCourtListAppellantOpens() throws NoSuchAlgorithmException {
        ...
        createHearingEvent(hearingEventId, courtRoom4Id, randomUUID().toString(), APPELLANT_OPPENS_EVENT_DEFINITION_ID, eventTime, of(hearingTypeId), courtCentreId_4);
    ...
    public void shouldGetLatestHearingEvents() throws NoSuchAlgorithmException {
        stubOrganisationalUnit(fromString(courtCentreId), "OUCODE");
        final InitiateHearingCommandHelper hearing = createHearingEvent(randomUUID(), courtRoom1Id, randomUUID().toString(), START_HEARING_EVENT_DEFINITION_ID, eventTime, of(hearingTypeId), courtCentreId);
    ...
    private InitiateHearingCommandHelper createHearingEvent(final UUID hearingEventId, final String courtRoomId, final String defenceCounselId, final UUID eventDefinitionId, final ZonedDateTime eventTime, final Optional<UUID> hearingTypeId, String courtCenter) throws NoSuchAlgorithmException {
        final InitiateHearingCommandHelper hearing = h(initiateHearing(getRequestSpec(), initiateHearingTemplateWithParam(fromString(courtCenter), fromString(courtRoomId), "CourtRoom 1", localDate, fromString(defenceCounselId), caseId, hearingTypeId)));
