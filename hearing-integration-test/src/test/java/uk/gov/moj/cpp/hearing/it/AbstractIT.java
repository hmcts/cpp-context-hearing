...
public class AbstractIT {
    ...
    protected static final UUID USER_ID_VALUE_AS_ADMIN = fromString("57986cb7-eefa-48b3-b7e2-34431c3265e5");
    ...
    public static void setUpJvm() {
        ...
        stubOrganisationUnitById(fromString("b52f805c-2821-4904-a0e0-26f7fda6dd08"));
    }
