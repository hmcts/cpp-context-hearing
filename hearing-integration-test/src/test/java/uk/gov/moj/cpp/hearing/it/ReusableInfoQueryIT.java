        ...
        poll(requestParams(getQueryReusableInfoUrl(hearingOne.getHearingId()), "application/vnd.hearing.query.reusable-info+json").withHeader(USER_ID, getLoggedInUser()))
                .until(
                        ...
                        payload().isJson(allOf(
                                withJsonPath("$.reusablePrompts", hasSize(0))
                        ))
                );
    }
        ...
        poll(requestParams(getQueryReusableInfoUrl(hearingOne.getHearingId()), "application/vnd.hearing.query.reusable-info+json").withHeader(USER_ID, getLoggedInUser()))
                .until(
                        ...
                        payload().isJson(allOf(
                                ...
                                withJsonPath("$.reusablePrompts[0].promptRef", is("minorcreditornameandaddress")),
                                withJsonPath("$.reusablePrompts[0].caseId", is(caseId.toString())),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressOrganisationName", is("ProsecutionAuthorityName")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressAddress1", is("line 1")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressAddress2", is("line 2")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressAddress3", is("line 3")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressAddress4", is("line 4")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressAddress5", is("line 5")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressPostCode", is("E14 4EX")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressEmailAddress1", is("contact@cpp.co.uk")),
                                withJsonPath("$.reusablePrompts[0].value.minorcreditornameandaddressCategoryCode", is("Charity"))
                        ))
                );
    }
}
