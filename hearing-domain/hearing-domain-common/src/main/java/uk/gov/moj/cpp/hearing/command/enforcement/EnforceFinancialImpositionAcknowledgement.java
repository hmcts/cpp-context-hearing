...
public class EnforceFinancialImpositionAcknowledgement implements Serializable {
    ...
    public EnforceFinancialImpositionAcknowledgement(final Acknowledgement acknowledgement, final ExportStatus exportStatus, final String originator, final UUID requestId, final ZonedDateTime updated) {
    ...
    public static class Builder {
        ...
        public EnforceFinancialImpositionAcknowledgement build() {
            return new EnforceFinancialImpositionAcknowledgement(acknowledgement, exportStatus, originator, requestId, updated);
        }
    }
}
