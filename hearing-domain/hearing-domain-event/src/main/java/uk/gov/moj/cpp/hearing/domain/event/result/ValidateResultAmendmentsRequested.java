...
public class ValidateResultAmendmentsRequested implements Serializable {
    ...
    public static ValidateResultAmendmentsRequestedBuilder validateResultAmendmentsRequested() {
        return new ValidateResultAmendmentsRequestedBuilder();
    }
    ...
    public static final class ValidateResultAmendmentsRequestedBuilder {
        ...
        public ValidateResultAmendmentsRequestedBuilder withHearingId(final UUID hearingId) {
            this.hearingId = hearingId;
            return this;
        }

        public ValidateResultAmendmentsRequestedBuilder withUserId(final UUID userId) {
            this.userId = userId;
            return this;
        }

        public ValidateResultAmendmentsRequestedBuilder withValidateResultAmendmentsTime(final ZonedDateTime validateResultAmendmentsTime) {
            this.validateResultAmendmentsTime = validateResultAmendmentsTime;
            return this;
        }
