...
@Event("hearing.plea-changed")
public class HearingPleaChanged {
    ...
    @JsonCreator
    public HearingPleaChanged(@JsonProperty(value = "caseId") final UUID caseId,
