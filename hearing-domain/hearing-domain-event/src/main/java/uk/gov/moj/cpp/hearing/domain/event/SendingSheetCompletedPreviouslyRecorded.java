...
public class SendingSheetCompletedPreviouslyRecorded {
    ...
    @JsonCreator
    public SendingSheetCompletedPreviouslyRecorded(
    ...
    public static class Builder {
        ...
        public SendingSheetCompletedPreviouslyRecorded build() {
            return new SendingSheetCompletedPreviouslyRecorded(crownCourtHearing, hearing);
        }
    }
}
