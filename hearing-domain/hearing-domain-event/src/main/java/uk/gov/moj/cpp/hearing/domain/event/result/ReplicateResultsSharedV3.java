...
@Event("hearing.events.replicate.results-shared-v3")
public class ReplicateResultsSharedV3 implements Serializable {
    ...
    public ReplicateResultsSharedV3() {
    }

    @JsonCreator
    private ReplicateResultsSharedV3(@JsonProperty("hearingId") final UUID hearingId,
    ...
    public static final class Builder {
        ...
        public ReplicateResultsSharedV3 build() {
            return new ReplicateResultsSharedV3(
                    hearingId,
                    sharedTime,
                    courtClerk,
                    hearing,
