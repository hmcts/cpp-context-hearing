...
@Event("hearing.events.results-shared-v2")
public class ResultsSharedV2 implements Serializable {
    ...
    public ResultsSharedV2() {
    }

    @JsonCreator
    private ResultsSharedV2(@JsonProperty("hearingId") final UUID hearingId,
    ...
    public static final class Builder {
        ...
        public ResultsSharedV2 build() {
            return new ResultsSharedV2(
                    hearingId,
                    sharedTime,
                    courtClerk,
                    hearing,
