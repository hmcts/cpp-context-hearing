...
@Event("hearing.event.publish-court-list-produced")
public class PublishCourtListProduced {
    ...
    public PublishCourtListProduced(final UUID courtCentreId, final UUID courtListFileId, final String courtListFileName, final ZonedDateTime createdTime, final PublishStatus publishStatus) {
    ...
    public static Builder publishCourtListProduced() {
        return new PublishCourtListProduced.Builder();
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final PublishCourtListProduced that = (PublishCourtListProduced) obj;
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(courtCentreId, courtListFileId, courtListFileName, createdTime, publishStatus);
    }

    @Override
    public String toString() {
        return "PublishCourtListProduced{" +
    ...
    public static class Builder {
        ...
        public PublishCourtListProduced build() {
            return new PublishCourtListProduced(courtCentreId, courtListFileId, courtListFileName, createdTime, publishStatus);
        }
    }
}
