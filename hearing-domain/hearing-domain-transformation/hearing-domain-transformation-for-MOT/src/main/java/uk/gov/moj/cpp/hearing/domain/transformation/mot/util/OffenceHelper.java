...
import static uk.gov.moj.cpp.hearing.domain.transformation.mot.core.SchemaVariableConstants.*;
...
public class OffenceHelper {
    ...
    public static JsonObject transformIndicatedPleaForSendingSheet(final JsonObject jsonObject) {
        return createObjectBuilder()
                .add(OFFENCE_ID, jsonObject.getString(OFFENCE_ID))
                .add(INDICATED_PLEA_VALUE, jsonObject.getString(INDICATED_PLEA_VALUE)).build();
    }
