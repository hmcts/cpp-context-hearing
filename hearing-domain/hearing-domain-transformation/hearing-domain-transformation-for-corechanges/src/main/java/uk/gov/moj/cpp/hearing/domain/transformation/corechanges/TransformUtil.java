...
public class TransformUtil {
    ...
    private static JsonArrayBuilder cloneArrayWithPathFilter(final JsonArray jsonArray, final BiFunction<JsonValue, Deque<String>, Object> filter, final Deque<String> path) {
    ...
    private static JsonObjectBuilder cloneObjectWithPathFilter(final JsonObject jsonObject, final BiFunction<JsonValue, Deque<String>, Object> filter, final Deque<String> path) {
