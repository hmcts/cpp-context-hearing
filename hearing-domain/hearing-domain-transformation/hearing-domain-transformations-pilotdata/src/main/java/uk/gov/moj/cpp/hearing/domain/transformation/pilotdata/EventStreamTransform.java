package uk.gov.moj.cpp.hearing.domain.transformation.pilotdata;
...
public class EventStreamTransform implements EventTransformation {
    ...
    public EventStreamTransform() {
        uuidList.addAll(Stream.of("applicationId.csv", "caseId.csv", "defendantId.csv", "hearingId.csv", "offenceId.csv")
