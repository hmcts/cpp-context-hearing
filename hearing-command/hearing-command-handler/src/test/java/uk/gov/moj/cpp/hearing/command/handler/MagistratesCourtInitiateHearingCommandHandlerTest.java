...
public class MagistratesCourtInitiateHearingCommandHandlerTest {
    ...
    public void setup() {
        ...
        when(this.aggregateService.get(this.eventStream, CaseAggregate.class)).thenReturn(caseAggregate);
    }
    ...
    public void testRecordSendingSheetComplete() throws Exception {
           ...
           Mockito.when( caseAggregate.recordSendingSheetComplete(sendingSheetCompleted) ).thenReturn(events);
